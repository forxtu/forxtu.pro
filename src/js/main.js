...
$(document).ready(function() {
    var originalBGplaypen = $(".site-wrap").css("background-color"),
        x, y, xy, bgWebKit, bgMoz,
        lightColor = "rgba(255,255,255,0.05)",
        gradientSize = 500;

    $('.site-wrap').mousemove(function (e) {
        ...
        bgMoz = "-moz-radial-gradient(" + x + "px " + y + "px 45deg, circle, " + lightColor + " 10%, " + originalBGplaypen + " " + gradientSize + "px)";
...
var canvas = document.getElementById("home_animation_main");
...
var textSet = [
    {text:"HELLO", sphereRadius:140, sphereSpace:100, unitTime:100, time:1500},
    {text:"I_AM_DENIS", sphereRadius:120, sphereSpace:70, unitTime:120, time:3000},
    {text:"MERKULOV", sphereRadius:120, sphereSpace:80, unitTime:100, time:3000},
    {text:"FORXTU", sphereRadius:120, sphereSpace:70, unitTime:50, time:3000},
    {text:"@@@@@@@@", sphereRadius:100, sphereSpace:60, unitTime:100, time:3500},
    {text:"FRONT_END", sphereRadius:140, sphereSpace:80, unitTime:100, time:1500},
    {text:"DEVELOPER", sphereRadius:70 + Math.random()*60, sphereSpace:70, unitTime:100, time:2500},
    {text:"FROM", sphereRadius:120, sphereSpace:100, unitTime:100, time:2500},
    {text:"KRAKOW", sphereRadius:100, sphereSpace:80, unitTime:150, time:2000},
    {text:"POLAND", sphereRadius:120, sphereSpace:90, unitTime:50, time:2300},
    {text:"WELCOME", sphereRadius:100, sphereSpace:80, unitTime:100, time:2500},
    {text:"AND", sphereRadius:100, sphereSpace:80, unitTime:100, time:2000},
    {text:"ENJOY!", sphereRadius:80 + Math.random()*60, sphereSpace:100, unitTime:100, time:1500},
    {text:"@@@@@@@!", sphereRadius:60 + Math.random()*60, sphereSpace:100, unitTime:100, time:4000}
];
...
document.body.onmousemove = function(e) {
    camera.rotate.x = e.pageY/window.innerHeight * 15 - 6;
    camera.rotate.y = e.pageX/window.innerWidth * 15 - 6;
